...
:: ── CONFIG ────────────────────────────────────────────────────────────────────
:: Your Langflow flow IDs (from your Langflow URL)
...
:: Paste it here once, then you never need to touch this file again
...
echo.
echo   Browser will open the docs site shortly.
